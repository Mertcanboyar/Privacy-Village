...
└──────────┬──────────────────────────────────┘
           │ WebSocket (live, local-only — see below)
┌──────────▼──────────┐
│  Colyseus server    │
│  (Node) — presence, │
│  positions          │
